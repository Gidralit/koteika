...
Так же при первом запуске нужно открыть Docker Desktop, затем зайти в контейнеры, открыть контейнер с api(backend), перейти во вкладку Exec и ввести php artisan migrate для применения миграций и создания таблиц.
